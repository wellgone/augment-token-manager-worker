/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 75c11eda66413aef0908d11a831b7e3e)
// Runtime types generated with workerd@1.20250917.0 2025-09-20 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
	}
	interface Env {
		USER_CREDENTIALS: "well:wellgone";
		EMAIL_DOMAINS: ["lwg-lawyer.com","welldone.ggff.net","well.edu.kg","ellgone.cn"];
		EMAIL_API_BASE_URL: "https://mail.wellgone.cn/";
		EMAIL_API_TOKEN: "";
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "USER_CREDENTIALS" | "EMAIL_DOMAINS" | "EMAIL_API_BASE_URL" | "EMAIL_API_TOKEN">> {}
}
